...
namespace Scarecrow
{
    ...
    public class FoldoutDrawer : MaterialPropertyDrawer
    {
        ...
        public FoldoutDrawer(float foldoutLevel, float foldoutStyle, float foldoutToggleDraw, float foldoutOpen, params string[] showList)
        {
            ...
            if(style > 10)
            {
                _colorIndex = style % 10;
                style = (int)(style / 10);
            }
            style = style > 10 ? (int)(style / 10) : style;
        ...
        private void FoldoutGUIDraw()
        {
            ...
            {
                case FoldoutStyle.Big: FoldoutGUIDraw_Shuriken(30, 0); break;
                case FoldoutStyle.Median: FoldoutGUIDraw_Shuriken(22, 0); break;
        ...
        private void FoldoutGUIDraw_Shuriken(float height, int fontSize)
        {
            ...
            style.contentOffset = new Vector2(20f, -2);//折叠页文本偏移
            ...
            Rect triangleRect = new Rect(rect.x + 4, rect.y + rect.height / 2 - 9, 14f, 14f);//创建三角形外观矩形
        ...
        private void SetFoldoutEditorKeyword(MaterialProperty pro, bool foldoutEditor)
        {
            ...
            {
                if (foldoutEditor && _foldoutToggleDraw)
