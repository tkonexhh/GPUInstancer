...
Shader "Inutan/URP/Effect/ParticleDistort 粒子扭曲" {
    // --------------------------------------------
    Properties {
        ...
        [Toggle_Switch] _UseNormalizedNDC("扭曲强度应用NDC归一化", float) = 0
    ...
    // --------------------------------------------
    SubShader {
        Tags {"Queue"="Transparent-2" "IgnoreProjector"="True" "RenderType"="Transparent" "RenderPipeline" = "UniversalPipeline"}

        Pass {
            Name "ParticleDistort"
            ...
            #pragma shader_feature_local _USENORMALIZEDNDC_ON
